...
class Cmd extends Table {
  ...
  public function GetById($id){
    ...
    cmd__client__id_fact  as devis__client__id,
  ...
  public function getFromStatus(){
    ...
    LEFT JOIN keyword as k ON cmd__etat = k.keyword__value
    WHERE cmd__etat = 'VLD'     
    ORDER BY  cmd__date_crea DESC , c.client__societe ASC  LIMIT 200 ");
    $data = $request->fetchAll(PDO::FETCH_OBJ);
    return $data;
  }
  ...
  public function insertOne(
    ...
    {
    $request = $this->Db->Pdo->prepare('INSERT INTO 2_cmd (
    ...
    $requestLigne =  $this->Db->Pdo->prepare('INSERT INTO  2_cmd_ligne (
    ...
    $requestGarantie =  $this->Db->Pdo->prepare('INSERT INTO  2_cmd_garantie ( 
