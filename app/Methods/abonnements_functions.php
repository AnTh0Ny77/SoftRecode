			...
			<table class="page_header" style="width: 100%; font-size: 85%;">
				<tr>
					<td style="text-align: center;  width: 100%">
						<h4>CONTRAT DE LOCATION<br>DE MATERIEL INFORMATIQUE</h4>
						<h4>CONDITIONS GENERALES</h4>
					</td>
				</tr>
				<tr>
					<td style="text-align: left;  width: 100%">
						<h4>CONTRAT N°: <b><?php echo $temp->devis__id ?></b></h4>
					</td>
				</tr>
				<tr>
					<td>
							...
							<tr>
								<td style="text-align: left; margin-left: 35%; padding-top: 10px;">
									...
									<div style=' padding: 5px 15px ; width: 280px;'>
										Ci-dessous dénommé<br>‘’LOCATAIRE’’
									</div>
								</td>
								<td style="text-align: left; margin-left: 35%; padding-top: 10px;">
			...
			<table>
				...
				<tr>
					<td style=" font-size: 95%; width: 100%; text-align: left;">
						...
						<li>Installation dans la 1° quinzaine : facturation au 1er</li>
						<li>Installation dans la 2° quinzaine : facturation au 15</li>
						</ul>
					</td>
				</tr>
				<tr>
...
<?php
		...
		try 
		{
			...
			ob_clean();
			$doc->output('O:\intranet\Auto_Print\CT\contrat'.$temp->devis__id.'-'.$num_ex.'.pdf', 'F');
		} 
