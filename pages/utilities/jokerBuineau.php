...
$totaux = Pdfunctions::totalFacturePDF($commande_temporaire, $ligne_temporaire);        
    ...
    else 
    {
            ...
            <page_header>
                <table class="page_header" style="width: 100%;">
                    ...
                    <tr>
                        ...
                        <h3>Facture : 4223729 le le 04/08/2022' </h3><br>
            ...
            <div style="margin-top: 35px; margin-bottom: 140px;">
            ...
            try 
            {
                ...
                // {
                    ...
                    try {
                        ...
                        $mail->addAddress('anthonybs.pro@gmail.com' , '');
                        $mail->addBCC('crm@recode.fr');
                        //Attachments
                        $mail->addAttachment(__DIR__ . '/facture_mail/' . $numFact . '.pdf');
                        //Content
                        $mail->isHTML(true);
                        $mail->Subject = 'Votre facture RECODE N: 4223729';
                        $mail->Body    = 'Vous trouverez ci-joint votre facture N: 4223729 de votre commande N: 3226838';
                        $mail->send();
                        $deleted = unlink(__DIR__ . '/facture_mail/'.'4223729.pdf');
