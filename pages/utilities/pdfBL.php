...
if(!empty($_POST['bonLivraison'])) {
$command = $Command->getById(intval($_POST['bonLivraison']));
$commandLignes = $Command->commandLigne($_POST['bonLivraison']);
...
<page backtop="10mm" backleft="15mm" backright="15mm">
     ...
     <table CELLSPACING=0 style="width: 100%;  margin-top: 150px; ">
             <tr style=" margin-top : 50px; background-color: #dedede; " >
               
                <th style="width: 80%; text-align: left">Désignation </th>
                <th style="text-align: right; width: 20%"><strong>CMD</strong></th>
             </tr> 
             <?php
             foreach ($commandLignes as $item) {
                ...
                echo "<tr  style='font-size: 85%;'>
                      <td style='border-bottom: 1px #ccc solid'> ". $item->cmdligne__model . " - ". $item->cmdligne__designation  ." </td>
