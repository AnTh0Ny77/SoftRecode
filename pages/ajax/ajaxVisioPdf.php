                ...
                <table class="page_header" style="width: 100%;">
                    <tr>
                        ...
                        <td style="text-align: left; width:50%">
                            ...
                            <h3>REPARATION-LOCATION-VENTE</h3>imprimantes-lecteurs codes-barres<br><a style="color: green;">www.recode.fr</a>
                            <br><br>
                        </td>
                    </tr>
                    <tr>
            ...
            <div style="margin-top: 55 px;">
                ...
                <table style="width: 100%;">
                    <table style="   margin-top: 5px; color: #8c8c8c; width: 100%;">
                        <tr>
                            <td style="font-size: 80%;"><small>Le client accepte la présente proposition ainsi que les condition générales de vente Recode.<br>Recode conserve la propriété du matériel jusqu'a
